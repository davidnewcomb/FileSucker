...
public class Base64
{
     ...
     * .org/rfcs/rfc3548.html</a>. Notice that the last two bytes become
     ...
     * is described here: <a href="http://www.faqs.org/qa/rfcc-1940.html"
            ...
            byte[] destination, int destOffset, int options)
    {
        ...
        {
            // Two ways to do the same thing. Don't know
            // which way I like best.
            // int outBuff = ( ( DECODABET[ source[
            // srcOffset ] ] << 24 ) >>> 6 )

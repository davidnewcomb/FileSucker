...
import net.sf.filesuka.BasicAuth;
import net.sf.filesuka.FileAndTextTransferHandler;
import net.sf.filesuka.FileSuka;
import net.sf.filesuka.FileSukaFrame;
import net.sf.filesuka.HistoryJComboBox;
import net.sf.filesuka.ListLooper;
import net.sf.filesuka.Looper;
import net.sf.filesuka.PrefixJTextField;
import net.sf.filesuka.RunYetComponent;
import net.sf.filesuka.SuffixJTextField;
import net.sf.filesuka.SukaParams;
import net.sf.filesuka.SukaThread;
import net.sf.filesuka.TaskScreenParams;
import net.sf.filesuka.Utility;
import net.sf.filesuka.gui.taskscreen.buttons.AkaButton;
import net.sf.filesuka.gui.taskscreen.buttons.BrowseButton;
import net.sf.filesuka.gui.taskscreen.buttons.ClipboardAsDirectoryButton;
import net.sf.filesuka.gui.taskscreen.buttons.CopyToToolClearButton;
import net.sf.filesuka.gui.taskscreen.buttons.DescriptionButton;
import net.sf.filesuka.gui.taskscreen.buttons.DirectoryAndPrefixButton;
import net.sf.filesuka.gui.taskscreen.buttons.DirectoryClipboardButton;
import net.sf.filesuka.gui.taskscreen.buttons.DirectoryExtensionButton;
import net.sf.filesuka.gui.taskscreen.buttons.HomeButton;
import net.sf.filesuka.gui.taskscreen.buttons.HomeDirectoryPrefix;
import net.sf.filesuka.gui.taskscreen.buttons.OpenDirectoryButton;
import net.sf.filesuka.gui.taskscreen.buttons.OriginalAddressLaunchButton;
import net.sf.filesuka.gui.taskscreen.buttons.PrefixButton;
import net.sf.filesuka.gui.taskscreen.buttons.PrefixClearButton;
import net.sf.filesuka.gui.taskscreen.buttons.PrefixCopyButton;
import net.sf.filesuka.gui.taskscreen.buttons.PrefixLowerButton;
import net.sf.filesuka.gui.taskscreen.buttons.SubDirectoryAndPrefixButton;
import net.sf.filesuka.gui.taskscreen.buttons.SubDirectoryAndPrefixFromClipboardButton;
import net.sf.filesuka.gui.taskscreen.buttons.SubDirectoryFromClipboardButton;
import net.sf.filesuka.gui.taskscreen.buttons.SubDirectoryPathButton;
import net.sf.filesuka.gui.taskscreen.buttons.SuffixButton;
import net.sf.filesuka.gui.taskscreen.buttons.SuffixClearButton;
import net.sf.filesuka.gui.taskscreen.buttons.SuffixCopyButton;
import net.sf.filesuka.gui.taskscreen.buttons.SuffixLowerButton;
...
public class TaskScreen extends JPanel
{
    ...
    public TaskScreen()
    {
        ...
        runB.addActionListener(new ActionListener()
            {
                public void actionPerformed(ActionEvent e)
                {
                    ...
                    String selectedDir = directoryCB.getSelectedItem()
                            .toString().trim();
                    if (selectedDir.equals(""))
                    {
                        TaskScreen
                                .setErrorMessage("You must provide a directory to store the files");
                        return;
                    }
        ...
        findFilesB
                .setToolTipText("Suck down webpage, fish out all the filenames and fill up 'L'");
        ...
        findFilesB.addActionListener(new ActionListener()
            {
                public void actionPerformed(ActionEvent e)
                {
                    try
                    {
                        ...
                        urlTF.setText(urlTF.getText().substring(0,
                                lastSlash + 1));
                    }
                    catch (Exception ex)
                    {
        ...
        OriginalAddressLaunchButton findFileLaunchB = new OriginalAddressLaunchButton(
                originalAddress);
        ...
        JButton cpButton = new SubDirectoryAndPrefixFromClipboardButton(
                directoryCB, prefixTF);
        ...
        JButton hpdpButton = new HomeDirectoryPrefix(urlTF, directoryCB,
                prefixTF);

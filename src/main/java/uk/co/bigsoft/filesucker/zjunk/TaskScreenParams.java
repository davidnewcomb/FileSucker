...
public class TaskScreenParams {
	...
	private static SuckerParams readVersion1(Properties p) {
		...
		SuckerParams sp = new SuckerParams(name, url, into, prefix, suffix, new Hashtable<String, String>(), suffixEnd,
				"");
		return sp;
	}
	...
	private static SuckerParams readVersion2(Properties p) {
		...
		SuckerParams sp = new SuckerParams(name, url, into, prefix, suffix, ht, suffixEnd, orginalAddress);
		return sp;

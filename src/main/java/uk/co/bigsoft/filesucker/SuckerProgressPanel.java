...
public class SuckerProgressPanel extends JPanel
{
    ...
    SuckerProgressPanel(SuckerThread spt, SuckerParams parm, int totalNoFiles)
    {
        ...
        totalNumberOfFiles = new JProgressBar(SwingConstants.HORIZONTAL, 0,
                totalNoFiles);
        totalNumberOfFiles.setValue(0);
        totalNumberOfFiles.setStringPainted(true);
        totalNumberOfFiles
                .setMinimumSize(new Dimension(0, TRANSFER_ROW_HEIGHT));
        totalNumberOfFiles.setMaximumSize(new Dimension(Integer.MAX_VALUE,
                TRANSFER_ROW_HEIGHT));

...
public class SubDirectoryAndPrefixButton extends JButton implements
        ActionListener
{
    ...
    public SubDirectoryAndPrefixButton(JTextField url,
            HistoryJComboBox directory, JTextField prefix)
    {
        super("/DP_");

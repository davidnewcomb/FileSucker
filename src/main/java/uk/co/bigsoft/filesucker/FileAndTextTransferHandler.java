...
public class FileAndTextTransferHandler extends TransferHandler {
	...
	public boolean importData(JComponent c, Transferable t) {
		System.out.println("FileAndTextTransferHandler:============:importData");
		JTextField tc;

		if (!canImport(c, t.getTransferDataFlavors())) {
			System.out.println("***FileAndTextTransferHandler:importData: can't import");
			return false;
		}
	...
	protected void exportDone(JComponent c, Transferable data, int action) {
		...
		System.out.println("FileAndTextTransferHandler:exportDone:from:" + tc1.getText());
		System.out.println("FileAndTextTransferHandler:exportDone:from:" + source.getText());
	...
	public boolean canImport(JComponent c, DataFlavor[] flavors) {
		if (hasFileFlavor(flavors)) {
			System.out.println("FileAndTextTransferHandler:canImport:hasFileFlavor:true");
			return true;
		}
		if (hasStringFlavor(flavors)) {
			System.out.println("FileAndTextTransferHandler:canImport:hasStringFlavor:true");
			return true;
		}

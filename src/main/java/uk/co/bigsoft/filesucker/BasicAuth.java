...
public class BasicAuth
{
    ...
    public static String encode(String name, String passwd)
    {
        ...
        /**
         * Loop through input with 3-byte stride. For each 'chunk' of 3-bytes,
         * create a 24-bit value, then extract four 6-bit indices. Use these
         * indices to extract the base-64 encoding for this 6-bit 'character'
         */
